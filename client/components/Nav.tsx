  ...
  return (
    <>
      <div className="relative h-full w-full">
        ...
        <h1 className="absolute bottom-0 left-1/4 h-full w-1/2 px-4 py-10  text-left text-8xl  font-semibold text-white">
          Snap Jam
        </h1>
      </div>
      <div className="nav-bar ">
        <div className="nav-title-div">
          <h1 className="xl font-bold text-slate-700">Snap Jam</h1>
        </div>
